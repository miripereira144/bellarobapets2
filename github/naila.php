    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Naila</h1>
                <p class="lead fw-normal text-white-50 mb-0"> 45 x 45 CM</p>
            </div>
        </div>
    </header>
    <!-- Section-->
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
              ...
              $consulta="SELECT * FROM `ropa` WHERE `prenda` = 'naila' ";
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center">
                                ...
                                <a href="https://www.mercadopago.com.ar/checkout/v1/redirect?preference-id=98841741-65228892-6c12-4507-9311-5407bef51636" class="btn btn-primary">Comprar</a>
                                <a class="btn btn-petshop mt-auto" href="index.php">Inicio</a>
                                <a class="btn btn-petshop mt-auto scroll-to-top" href="naila.php">Volver al Inicio</a>
                            </div>
                        </div>
                    </div>
                </div>
