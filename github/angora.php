    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Angora</h1>
                <p class="lead fw-normal text-white-50 mb-0"> 50 x 80 CM</p>
            </div>
        </div>
    </header>
    <!-- Section-->
        ...
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
             ...
             mysqli_select_db($conexion, "if0_37011039_tienda");
              ...
              $consulta="SELECT * FROM `ropa` WHERE `prenda` = 'angora' ";
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                               ...
                               <a href="https://www.mercadopago.com.ar/checkout/v1/redirect?preference-id=98841741-c797c606-185b-436b-a907-6325ed3519d2" class="btn btn-primary">Comprar</a>
